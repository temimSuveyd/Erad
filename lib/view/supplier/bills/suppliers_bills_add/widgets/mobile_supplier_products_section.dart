...
class MobileSupplierProductsSection
    extends GetView<SupplierBiilAddControllerImp> {
  const MobileSupplierProductsSection({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: DesignTokens.spacing8),
          Text(
            'ابدأ بإضافة المنتجات المشتراة من المورد',
            style: DesignTokens.getBodyMedium(
              context,
            ).copyWith(color: AppColors.textSecondary),

...
class MobileSupplierBillCard extends GetView<SuppliersBillViewControllerImp> {
  const MobileSupplierBillCard({super.key, required this.billModel});
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Header Row: Supplier Name and Amount
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        billModel.supplier_name ?? 'غير محدد',
                ...
                Row(
                  children: [
                    ...
                    Text(
                      billModel.supplier_city ?? 'غير محدد',

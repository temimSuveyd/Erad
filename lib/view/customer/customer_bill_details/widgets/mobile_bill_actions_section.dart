...
class MobileBillActionsSection
    extends GetView<CustomerBillDetailsControllerImp> {
  const MobileBillActionsSection({super.key});
                    ...
                    children: [
                      Expanded(
                        child: _buildActionButton(
                          ...
                          AppColors.primary,
                          () => controller.showEditPaymentTypeDailog(),
                        ),
                      ),
                      const SizedBox(width: DesignTokens.spacing12),
                      Expanded(
                        child: _buildActionButton(
                          ...
                          AppColors.error,
                          () => controller.show_delete_bill_dialog(),
                        ),
                      ),
                    ],
                  ),

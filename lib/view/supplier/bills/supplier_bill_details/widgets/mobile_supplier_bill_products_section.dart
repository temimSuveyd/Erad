...
class MobileSupplierBillProductsSection
    extends GetView<SuppliersBillDetailsControllerImp> {
  const MobileSupplierBillProductsSection({super.key});
            ...
            children: [
              ...
              if (controller.statusreqest == Statusreqest.loading)
                const Center(
                  ...
                  controller.supplierProductList.isEmpty)
                ...
                Obx(
                  () => ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      final product = controller.supplierProductList[index];
  ...
  Widget _buildProductCard(
    ...
    dynamic product,
    SuppliersBillDetailsControllerImp controller,
  ) {
          ...
          Row(
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () => controller.editSupplierProductData(productId),
                    child: Container(
                      width: 36,
                      height: 36,
                      decoration: BoxDecoration(

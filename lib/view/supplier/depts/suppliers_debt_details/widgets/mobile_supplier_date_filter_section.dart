...
class MobileSupplierDateFilterSection
    extends GetView<SupplierDeptsDetailsControllerImpl> {
  const MobileSupplierDateFilterSection({super.key});
  ...
  String _getDateRangeText(SupplierDeptsDetailsControllerImpl controller) {

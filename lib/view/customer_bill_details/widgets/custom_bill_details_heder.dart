...
import 'package:Erad/view/customer_bill_details/widgets/custom_biil_details_text_container.dart';
                    ...
                    widget: Row(
                      ...
                      children: [
                        ...
                        Custom_biil_details_text_container(
                          ...
                          color: controller.total_price!< 0 ? AppColors.red : AppColors.green,
                        ),
                        Custom_biil_details_text_container(
                          title_1:
                              controller.total_earn?.toString() ?? "قيمة فارغة",
                          title_2: "إجمالي الأرباح",
                          color: controller.total_earn!< 0 ? AppColors.red : AppColors.green,
                        ),

                        Custom_biil_details_text_container(
                          title_1:
                              controller.discount_amount.toString() ,

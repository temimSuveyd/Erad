...
class MobilePaymentsSection extends GetView<CustomerDeptsDetailsControllerImp> {
  const MobilePaymentsSection({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'لم يتم تسديد أي دفعات في هذا النطاق الزمني',
            style: DesignTokens.getBodyMedium(
              context,
            ).copyWith(color: AppColors.textSecondary),

...
class MobileExpensesCategoryHeader
    extends GetView<ExpensesCategoryControllerImp> {
  const MobileExpensesCategoryHeader({super.key});
  ...
  Widget _buildStatisticsCard(BuildContext context) {
    final totalCategories = controller.expensesList.length;

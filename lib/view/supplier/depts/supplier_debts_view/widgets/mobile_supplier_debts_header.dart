...
class MobileSupplierDebtsHeader
    extends GetView<SupplierDeptsViewControllerImp> {
  const MobileSupplierDebtsHeader({super.key});
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'متابعة وإدارة المبالغ المستحقة للموردين',
  ...
  Widget _buildStatisticsCards(BuildContext context) {
    ...
    final totalDebts = controller.supplierDeptsList.length;
    final totalAmount = controller.supplierDeptsList.fold<double>(0.0, (
      sum,
      debt,
    ) {
      final data = debt.data() as Map<String, dynamic>;
      return sum + (data['total_price']?.toDouble() ?? 0.0);
    });

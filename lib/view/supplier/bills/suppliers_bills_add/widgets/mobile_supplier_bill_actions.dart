...
class MobileSupplierBillActions extends GetView<SupplierBiilAddControllerImp> {
  const MobileSupplierBillActions({super.key});
  ...
  Widget _buildStatusIndicator(BuildContext context) {
    ...
    final statusText = isSaved ? 'تم حفظ فاتورة المورد' : 'لم يتم حفظ الفاتورة';
    final statusSubtext =
        isSaved
  ...
  Widget _buildValidationMessages(BuildContext context) {
    ...
    if (controller.supplier_name == null) {
      messages.add('يجب اختيار المورد');
    }
  ...
  bool _canSave() {
    return controller.supplier_name != null &&

...
class MobileBrandCard extends GetView<BrandsControllerImp> {
  const MobileBrandCard({super.key, required this.title});
            ...
            child: Row(
              children: [
                ...
                PopupMenuButton<String>(
                  onSelected: (value) {
                    if (value == 'delete') {
                      controller.show_delete_dialog(title);
                    } else if (value == 'details') {
                      controller.go_to_brands_type_page(title);
                    }
                  },
                  itemBuilder:
                      (context) => [

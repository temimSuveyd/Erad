...
class MobileCategoryTypeHeader extends GetView<CategoreyTypeControllerImp> {
  const MobileCategoryTypeHeader({super.key});
  ...
  Widget _buildStatisticsCard(BuildContext context) {
    final totalTypes = controller.categoreyTypeList.length;
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.layers_outlined, color: AppColors.white, size: 24),

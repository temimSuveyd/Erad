...
class MobileSupplierBillForm extends GetView<SupplierBiilAddControllerImp> {
  const MobileSupplierBillForm({super.key});
              ...
              children: [
                ...
                _buildFormField(
                  ...
                  CustomDropDownButton(
                    ...
                    onChanged: (value) => controller.setSupplierId(value),
                    hint: controller.supplier_name ?? "اختر المورد",
                    value: "",
                  ),
                ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          controller.bill_payment_type == "Religion"
                              ? 'سيتم إضافة هذا المبلغ إلى ديون المورد'
                              : 'سيتم دفع المبلغ نقداً للمورد',

...
class MobileBrandsHeader extends GetView<BrandsControllerImp> {
  const MobileBrandsHeader({super.key});
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'إدارة وتنظيم العلامات التجارية',
  ...
  Widget _buildStatisticsCard(BuildContext context) {
    final totalBrands = controller.brandsList.length;
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.business_outlined, color: AppColors.white, size: 24),

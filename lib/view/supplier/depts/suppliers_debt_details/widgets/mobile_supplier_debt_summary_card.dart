...
class MobileSupplierDebtSummaryCard
    extends GetView<SupplierDeptsDetailsControllerImpl> {
  const MobileSupplierDebtSummaryCard({super.key});
              ...
              children: [
                ...
                if (controller.deptModel != null) ...[
                  _buildInfoRow(
                    context,
                    'المورد',
                    controller.deptModel!.supplier_name ?? 'غير محدد',
                  ...
                  _buildInfoRow(
                    context,
                    'المدينة',
                    controller.deptModel!.supplier_city ?? 'غير محدد',
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          controller.remainingDebtAamount > 0
                              ? 'يوجد مبلغ مستحق للمورد'
                              : 'تم سداد جميع المستحقات للمورد',
                          style: DesignTokens.getBodyMedium(context).copyWith(
                            color:
                                controller.remainingDebtAamount > 0
                                    ? AppColors.warning
  ...
  double _calculateTotalDebts(SupplierDeptsDetailsControllerImpl controller) {
    double total = 0;
  ...
  double _calculateTotalPayments(
    SupplierDeptsDetailsControllerImpl controller,
  ) {
    double total = 0;
